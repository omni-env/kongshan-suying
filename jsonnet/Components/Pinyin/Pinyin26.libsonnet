...

{
  ...
  new(isDark, isPortrait, keyboardType=KeyboardType.Chinese,isTemp26=false):
    ...
    preedit.new(isDark)
    + toolbar.new(isDark, isPortrait, if keyboardType == KeyboardType.Chinese then 'pinyin' else 'alphabetic', {isTemp26: isTemp26})
